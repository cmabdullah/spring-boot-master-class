# Goal -> 095 Step 10  More JPA Repository  findById and findAll
...
### UserDAORepositoryCommandLineRunner.java
```java
package com.abdullah.khan.jpain10steps;
...
import com.abdullah.khan.jpain10steps.entity.User;
import com.abdullah.khan.jpain10steps.service.UserDAORepository;

@Component
public class UserDAORepositoryCommandLineRunner implements CommandLineRunner{
	public static final Logger log  = LoggerFactory.getLogger(UserDAORepositoryCommandLineRunner.class);
	@Autowired
	private UserDAORepository userDAORepository;

	@Override
	public void run(String... args) throws Exception {
		User user = new User("Tanim" , "Admin");
		userDAORepository.save(user);
		//New User is created : User [id=1, name=Abdullah, role=Admin]
		log.info("New User is created : "+user);	
		
		Optional<User> userWithIdOne= userDAORepository.findById(1L);
		
		log.info("First member is : "+ userWithIdOne);
		
		List<User> all = userDAORepository.findAll();
		
		log.info("All users are : "+ all);
	}
}
